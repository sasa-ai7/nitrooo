...
const translations = {
  en: {
    ...
    checkout: {
      ...
      detectingRegion: "Detecting the best payment route for your region...",
      localMethodsBadge: "Local payment methods available 🇪🇬",
      globalMethodsBadge: "Global secure checkout active",
      globalMethodsNotice: "For your region, Nitro X currently supports secure card and crypto payments only.",
    ...
    toasts: {
      ...
      vodafoneFailed: "Vodafone Cash review failed",
      cryptoFailed: "Crypto payment failed",
      cardDeclined: "❌ Payment Declined: There is an issue with your card details.",
      vodafoneScreenshot: "The screenshot was not clear enough. Please contact support with your Order ID.",
      cryptoIssue: "A wallet provider issue prevented confirmation. Please contact support.",
      cardIssue: "Please review your card details or choose another payment method.",
    },
    statuses: {
      ...
      rejected: "Rejected",
      screenshotNotClear: "Screenshot not clear enough",
      ...
      screenshotSupport: "Open support and share your Order ID together with a clear Vodafone Cash screenshot.",
      ...
      failed: "Failed",
      walletIssue: "Wallet provider issue",
      walletIssueDesc:
      ...
      cardSupportFinal: "Open support if you need help selecting another payment option.",
    },
  },
  ar: {
    ...
    checkout: {
      ...
      detectingRegion: "جارٍ تحديد أفضل وسيلة دفع لمنطقتك...",
      localMethodsBadge: "وسائل دفع محلية متاحة 🇪🇬",
      globalMethodsBadge: "دفع عالمي آمن مفعل",
      globalMethodsNotice: "في منطقتك، يدعم Nitro X حاليًا فقط الدفع الآمن بالبطاقة والعملات الرقمية.",
    ...
    toasts: {
      ...
      vodafoneFailed: "فشل مراجعة فودافون كاش",
      cryptoFailed: "فشل دفع العملات الرقمية",
      cardDeclined: "❌ تم رفض الدفع: توجد مشكلة في بيانات بطاقتك.",
      vodafoneScreenshot: "لقطة الشاشة غير واضحة بما يكفي. يرجى التواصل مع الدعم مع رقم الطلب.",
      cryptoIssue: "حدثت مشكلة لدى مزود المحفظة ومنعت تأكيد العملية. يرجى التواصل مع الدعم.",
      cardIssue: "يرجى مراجعة بيانات البطاقة أو اختيار طريقة دفع أخرى.",
    },
    statuses: {
      ...
      failed: "فشل",
      walletIssue: "مشكلة لدى مزود المحفظة",
      walletIssueDesc:
        "تعذر تأكيد عملية الدفع بالعملات الرقمية بسبب مشكلة مؤقتة لدى مزود المحفظة. يرجى التواصل مع الدعم أو المحاولة لاحقًا.",
      ...
      declined: "مرفوض",
      cardDeclinedTitle: "تم رفض الدفع بالبطاقة",
      cardDeclinedDesc:
        "تم رفض الدفع لأن هناك مشكلة في بيانات بطاقتك. يرجى مراجعتها والمحاولة مرة أخرى أو استخدام طريقة دفع أخرى.",
